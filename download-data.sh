...
# don't re-clone moses if you've already got it installed
# (e.g. via AUR, which installs it to /opt/

if [ -z "$MOSES_SCRIPTS" ]; then
    # default to this path, which
    # will cause Moses to be cloned
...
MOSES_TOK=$MOSES_SCRIPTS/tokenizer

# note: English side of nepali PTB data is tokenized using Moses
